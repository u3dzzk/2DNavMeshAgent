...
namespace PolyNav
{
    ...
    public class PolyNavAgent : MonoBehaviour
    {
        ...
        ///Raised when a new destination is started after path found  在找到路径后启动新目标时引发
        public event System.Action OnNavigationStarted;
        ///Raised when the destination is reached 到达目标时引发
        public event System.Action OnDestinationReached;
        ///Raised when the destination is or becomes invalid 当目标无效或变得无效时引发
        public event System.Action OnDestinationInvalid;
        ///Raised when a "corner" point has been reached while traversing the path    在穿越路径时到达“拐角”点时引发
